...
def view_feedback_view(request):
    feedbacks=models.Feedback.objects.all().order_by('-id')
    return render(request,'blood/view_feedback.html',{'feedbacks':feedbacks})
...
def send_feedback_view(request):
    ...
    if request.method == 'POST':
        ...
        if feedbackForm.is_valid():
            feedbackForm.save()
            return render(request,'blood/feedback_sent.html')
    return render(request,'blood/send_feedback.html',{'feedbackForm':feedbackForm})
